...
export default function car1(){
    return(
        <div className="mt-5 mx-48 bg-gray-100 p-5 mb-5">
            <h1 className="text-center text-3xl font-bold"><u>Suzuki Alto 2024 Price in Pakistan,Images,Reviews & Specs</u></h1>
...
<h1 className="text-green-600 text-xl mt-8 font-mono text-center">PKR 35,00,000</h1>
